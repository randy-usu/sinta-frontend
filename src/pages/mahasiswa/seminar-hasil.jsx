    ...
    <Box sx={{ flexGrow: 1, background: '#fafafa' }}>
      <>
        <Stack direction="row">
          ...
          <React.Fragment>
            <Button variant="contained" endIcon={<AddIcon />} onClick={handleOpenHasil} sx={{ ml: 3, borderRadius: 5, color: 'black', background: '#E0E0E0' }} onMouseEnter={changeHover} onMouseLeave={changeNormal}>
              Ajukan
            </Button>
            <Dialog
              fullScreen={fullScreen}
