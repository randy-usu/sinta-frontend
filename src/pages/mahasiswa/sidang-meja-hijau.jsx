...
export default function SidangMejaHijau() {
  ...
  return(
    ...
    <Stack direction="row">
      ...
      <React.Fragment>
        <Button variant="contained" endIcon={<AddIcon />} onClick={handleOpenSidang} sx={{ ml: 3, borderRadius: 5, color: 'black', background: '#E0E0E0' }} onMouseEnter={changeHover} onMouseLeave={changeNormal}>
          Ajukan
        </Button>
        <Dialog
              fullScreen={fullScreen}
              ...
              <DialogActions>
                <Button autoFocus variant="contained" onClick={handleCloseSidang}>
                    SIMPAN
                  </Button>
                </DialogActions>
            </Dialog>
